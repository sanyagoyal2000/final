        ...
        <div className="flex flex-wrap">
          <div className="w-full lg:w-12/12 px-4">
            <div className="relative w-full mb-3">
              ...
              name="about"
              value={data.about}
              onChange={handleChange} placeholder="I have been working as a Software Developer for Over a year now in FAANGUMH."> </textarea>
            </div>
          </div>
        </div>
        <hr className="mt-6 border-b-1 border-blueGray-300"/>
  <button className="bg-green-600 text-white active:bg-pink-600 font-bold uppercase text-xs mt-4 px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="submit" onClick={handleClick}>
          REGISTER
        </button>
      </form>
    </div>
