...
function Blogs() {
    ...
    <div className="rounded overflow-hidden shadow-lg">
      <img className="w-full" src="./images/doctor.jpg" alt="Doctor"/>
    ...
    <div className="rounded overflow-hidden shadow-lg">
      <img className="w-full" src="./images/nurse.jpg" alt="Nurse"/>
      <div className="px-6 py-4">
    ...
    <div className="rounded overflow-hidden shadow-lg">
      <img className="w-full" src="./images/teacher.jpg" alt="Teacher"/>
      <div className="px-6 py-4">
    ...
    <div className="rounded overflow-hidden shadow-lg">
      <img className="w-full" src="./images/engineer.jpg" alt="Engineer"/>
      <div className="px-6 py-4">
    ...
    <div className="rounded overflow-hidden shadow-lg">
      <img className="w-full" src="./images/police.jpg" alt="Police"/>
      <div className="px-6 py-4">
    ...
    <div className="rounded overflow-hidden shadow-lg">
      <img className="w-full" src="./images/lawyer.jpg" alt="Lawyer"/>
      <div className="px-6 py-4">
